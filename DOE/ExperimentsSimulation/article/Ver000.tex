...
\pgfplotsset{compat=newest, samples=60} %Set this value to 65 for the final version
...
\begin{figure}
	...
	\begin{axis}
		...
		\addplot3[contour gnuplot ={number=40,
			labels=false,
		},
		domain = 0:100,
		domain y = -1:1,
