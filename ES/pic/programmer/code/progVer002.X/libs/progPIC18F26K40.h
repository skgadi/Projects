...
#define PIC18F26K40_DELAY_MIN()          (__delay_us(2)) // T_ENTS, T_CKL, T_CKH, T_DS, T_DH
#define PIC18F26K40_DELAY_T_ENTH()       (__delay_us(500)) //250
#define PIC18F26K40_DELAY_TENTH()        (__delay_us(500)) //250
#define PIC18F26K40_DELAY_T_PEXT_1()     (__delay_ms(2)) 
#define PIC18F26K40_DELAY_T_PEXT_2()     (__delay_us(500))
