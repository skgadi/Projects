...
//#define START_TIME_OF_SIMULATION 0
#define SET_IOS_ON
//#define SET_RTC_SYNC
//#define SET_GPS_SYNC
#define GPS_SYNC_EVERY_x_SEC
     
//--------------------Variable for Temporal Sincronizaton
#define LOAD_TIME_FROM_GPS_EVERY_x_SECONDS (1*10*60)
#define READ_GPS_AFTER_x_S_AFTER_SWITCHING_ON (2*60)//A maximum of 65535
#define DISABLE_GPS_AFTER_x_NON_SYNC_CYCLES (3) 
...
//Data to EEPROM
//eeprom char EE_C_D =0x00;eeprom char EE_C[3][3] = {{1, 81, 127},{1, 81, 127},{1, 81, 127},};eeprom char EE_STATE_BREAKS[3] = {8,21,30,};eeprom char EE_STATES[30][5]= {{82,0x20,0x90,0x01,0x00},{3,0x22,0x90,0x00,0x00},{6,0x0C,0x90,0x00,0x00},{2,0x04,0x90,0x08,0x00},{2,0x14,0x90,0x00,0x00},{21,0x24,0x28,0x00,0x00},{2,0x24,0x10,0x00,0x20},{2,0x24,0x50,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},};eeprom char EE_AUDIO[4]= {0x04,0x00,0x00,0x00,};
eeprom char EE_C_D =0x00;eeprom char EE_C[3][3] = {{1, 81, 127},{1, 81, 127},{1, 81, 127},};eeprom char EE_STATE_BREAKS[3] = {7,21,30,};eeprom char EE_STATES[30][5]= {{78,0x21,0x90,0x00,0x00},{4,0x20,0x90,0x01,0x00},{3,0x22,0x90,0x00,0x00},{15,0x24,0x88,0x00,0x00},{15,0x0C,0x30,0x00,0x00},{2,0x04,0x10,0x08,0x20},{3,0x14,0x50,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},{0,0x00,0x00,0x00,0x00},};eeprom char EE_AUDIO[4]= {0x10,0x00,0x00,0x00,};
