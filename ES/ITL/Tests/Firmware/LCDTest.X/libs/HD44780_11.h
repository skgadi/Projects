...
#define LCD_CK_DEL	150	// It defines the time (in micro-seconds) that LCD_EN
...
// DATA BUS
#define LCD_DB0 	RB0	// DB0 - in 4-bit mode it has to be the same as LCD_DB4
#define LCD_DB1 	RB1	// DB1 - in 4-bit mode it has to be the same as LCD_DB5
#define LCD_DB2 	RB2	// DB2 - in 4-bit mode it has to be the same as LCD_DB6
#define LCD_DB3 	RB3	// DB3 - in 4-bit mode it has to be the same as LCD_DB7
