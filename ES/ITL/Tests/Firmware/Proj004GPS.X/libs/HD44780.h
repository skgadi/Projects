...
//==============================================================================
#define LCD_RD7     LATAbits.LA5    // D7
#define TRISRD7     TRISAbits.TRISA5

#define LCD_RD6     LATAbits.LA4       // D6
#define TRISRD6     TRISAbits.TRISA4

#define LCD_RD5     LATAbits.LA3       // D5
#define TRISRD5     TRISAbits.TRISA3

#define LCD_RD4     LATAbits.LA2       // D4
#define TRISRD4     TRISAbits.TRISA2

#define LCD_EN      LATAbits.LA1       // EN
#define TRISEN      TRISAbits.TRISA1

#define LCD_RS      LATAbits.LA0       // RS
