...
uint32_t GPS2Sec(char *GPSTime) {
    uint32_t TimeInSec;
    TimeInSec = (GPSTime[5]-0x30);
    TimeInSec = TimeInSec + (GPSTime[4]-0x30)*10;
    TimeInSec = TimeInSec + (GPSTime[3]-0x30)*60;
    TimeInSec = TimeInSec + (GPSTime[2]-0x30)*60*10;
    TimeInSec = TimeInSec + (GPSTime[1]-0x30)*60*60;
    TimeInSec = TimeInSec + (GPSTime[0]-0x30)*36000;
    return TimeInSec;
}