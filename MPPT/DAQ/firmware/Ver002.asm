...
CompTempVar2844                  EQU	0x00000257 ; bytes:1
CompTempVar2846                  EQU	0x00000258 ; bytes:1
CompTempVar2852                  EQU	0x00000257 ; bytes:1
CompTempVar2854                  EQU	0x00000258 ; bytes:1
...
label159
	MOVLW 0x61
	MOVWF gbl_FCV_READINPUT, 1
	CLRF gbl_FCV_READINPUT+D'1', 1
	MOVF gbl_FCV_READINPUT, F, 1
	MOVF gbl_FCV_READINPUT+D'1', W, 1
	MOVWF CompTempVar2846, 1
	BCF STATUS,C
	RLCF gbl_FCV_READINPUT, F, 1
	RLCF CompTempVar2846, F, 1
	MOVLW 0x01
	IORWF gbl_FCV_READINPUT, F, 1
	MOVF CompTempVar2846, W, 1
	IORLW 0x10
	MOVWF CompTempVar2844, 1
	MOVF CompTempVar2844, W, 1
	MOVWF gbl_FCV_READINPUT+D'1', 1
	MOVF gbl_FCV_READINPUT, W, 1
	MOVWF gbl_FCV_OUTSTRING, 1
	MOVF gbl_FCV_READINPUT+D'1', W, 1
	...
	MOVF gbl_FCV_READINPUT, F, 1
	MOVF gbl_FCV_READINPUT+D'1', W, 1
	MOVWF CompTempVar2854, 1
	BCF STATUS,C
	RLCF gbl_FCV_READINPUT, F, 1
	RLCF CompTempVar2854, F, 1
	MOVLW 0x01
	IORWF gbl_FCV_READINPUT, F, 1
	MOVF CompTempVar2854, W, 1
	IORLW 0x10
	MOVWF CompTempVar2852, 1
	MOVF CompTempVar2852, W, 1
	MOVWF gbl_FCV_READINPUT+D'1', 1
	MOVF gbl_FCV_READINPUT, W, 1
	MOVWF gbl_FCV_OUTSTRING, 1
	MOVF gbl_FCV_READINPUT+D'1', W, 1
