//************************************************************************************
//**  
//**  Source name:   D:\GitHub\Projects\MPPT\DAQ\firmware\PWMVer000.fcfx
//**  Title:         
//**  Description:   
//**  Device:        PIC.18F.18F14K50
//**  
//**  Generated by:  Flowcode v6.1.3.2
//**  Date:          Wednesday, February 22, 2017 12:12:54
//**  Users:         -1
...
MX_GLOBAL MX_CHAR FCV_INSTRING[FCVsz_INSTRING];
...
anselh = 0x00;
	...
	while (1)
	{
		...
		// Call Component Macro
		// Call Component Macro: InString=v5__usbserial0::ReadString(1, 3)
		FCD_056e1_v5__usbserial0__ReadString(FCV_INSTRING,3, 1, 3);

		// Decision
		// Decision: InString[0] = 0x31?
		if (FCV_INSTRING[0] == 0x31)
		{

			// Calculation
			// Calculation:
			//  InString = Right$ (InString,2)
			//  ReadInput = StringToInt$ (InString)
			FCI_RIGHTSTRING(FCV_INSTRING, FCVsz_INSTRING, 2, FCV_INSTRING,3);
			FCV_READINPUT = FCI_STRING_TO_INT(FCV_INSTRING, FCVsz_INSTRING);

			// Call Component Macro
			// Call Component Macro: PWM1::SetDutyCycle10Bit(ReadInput)
			FCD_0df41_PWM1__SetDutyCycle10Bit(FCV_READINPUT);
