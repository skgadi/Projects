//************************************************************************************
//**  
//**  Source name:   D:\GitHub\Projects\MPPT\DAQ\firmware\Ver002.fcfx
//**  Title:         
//**  Description:   
//**  Device:        PIC.18F.18F14K50
//**  
//**  Generated by:  Flowcode v6.1.3.2
//**  Date:          Thursday, February 16, 2017 17:27:30
//**  Users:         -1
...
anselh = 0x00;
	...
	while (1)
	{
		...
		// Call Component Macro
		// Call Component Macro: Operation=v5__usbserial0::ReadByte(1)
		FCV_OPERATION = FCD_056e1_v5__usbserial0__ReadByte(1);
		...
		// Decision
		// Decision: Operation = 0x31?
		if (FCV_OPERATION == 0x31)
		{
