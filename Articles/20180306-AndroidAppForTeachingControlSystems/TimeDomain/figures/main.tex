...
\tikzstyle{FigureArrow} = [-stealth, line width=0.5mm]
...
\begin{figure}
	...
	\draw [FigureArrow] (-4,2.4) node[right] {\Large $u(t)$} -| (-6.3, 1.9);
...
\begin{figure}
	...
	\draw [FigureArrow] (-4.5,5.5) node[right] {\Large $u(t)$} -| (-6.1, 7.075);
	\draw [FigureArrow] (-4.5,4.5) node[right] {\Large $y(t)$} -| (-8.25, 6.7);
	\draw [FigureArrow] (-4.5,3.5) node[right] {\Large $\hat{y}(t)$} -- (-8.2, 3.5);
	\draw [FigureArrow] (-4.5,-7) node[right] {\Large $\hat\theta_1(t)$} -- (-7.67, -7);
	\draw [FigureArrow] (-4.5,-4.5) node[right] {\Large $\hat\theta_2(t)$} -| (-7.5, -5.47);
	\draw [FigureArrow] (-4.5,-2) node[right] {\Large $\hat\theta_3(t)$} -- (-7.5, -2);
	\end{tikzpicture}
...
\begin{figure}
	...
	\draw [FigureArrow] (-4.5,5.8) node[right] {\Large $u(t)$} -- (-8.375, 5.8);
	\draw [FigureArrow] (-4.5,3.8) node[right] {\Large $y(t)$} -| (-6, 2.25);
	\draw [FigureArrow] (-4.5,1.8) node[right] {\Large $\hat{y}(t)$} -- (-7.95, 1.8);
	\end{tikzpicture}
